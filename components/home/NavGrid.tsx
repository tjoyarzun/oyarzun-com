...
const cards: NavCard[] = [
  {
    icon: User,
    label: "Our Profiles",
    description: "Skills, careers, and projects",
    href: "/profiles",
    color: "teal",
  },
  {
    icon: Mountain,
    label: "Travels & Adventures",
    description: `${travelStats.adventuresLogged} adventures across ${travelStats.countriesVisited} countries`,
    href: "/travels",
    color: "orange",
  },
  {
    ...
    description: "Because we track everything",
    href: "/dashboard",
    color: "teal",
  },
  {
